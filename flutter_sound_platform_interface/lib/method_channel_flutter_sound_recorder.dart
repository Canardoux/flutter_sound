...
class MethodChannelFlutterSoundRecorder extends FlutterSoundRecorderPlatform {
  ...
  Future<dynamic>? channelMethodCallHandler(MethodCall call) {
    ...
    switch (call.method) {
      case "updateRecorderProgress":
        {
          aRecorder!
              .updateRecorderProgress(duration: call.arguments['duration'], dbPeakLevel: call.arguments['dbPeakLevel']);
        }
        break;
  ...
  Future<bool> invokeMethodBool(
      FlutterSoundRecorderCallback callback, String methodName, Map<String, dynamic> call) async {
    call['slotNo'] = findSession(callback);
