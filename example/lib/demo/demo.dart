...
class _MyAppState extends State<Demo> {
  ...
  List<String> remoteSample = [
    'https://tau.canardoux.xyz/live/extract/01.aac', // 'assets/samples/sample.aac',
    'https://tau.canardoux.xyz/live/extract/01.aac', // 'assets/samples/sample.aac',
    'https://tau.canardoux.xyz/live/extract/08.opus', // 'assets/samples/sample.opus',
    'https://tau.canardoux.xyz/live/extract/04-opus.caf', // 'assets/samples/sample_opus.caf',
    'https://tau.canardoux.xyz/live/extract/05.mp3', // 'assets/samples/sample.mp3',
    'https://tau.canardoux.xyz/live/extract/07.ogg', // 'assets/samples/sample.ogg',
    'https://tau.canardoux.xyz/live/extract/sample_s16_2ch.pcm', // Raw PCM int16
    'https://tau.canardoux.xyz/live/extract/sample_2ch.wav', // int16 wav stereo
    'https://tau.canardoux.xyz/live/extract/02.aiff', // 'assets/samples/sample.aiff',
    'https://tau.canardoux.xyz/live/extract/01-pcm.caf', // 'assets/samples/sample_pcm.caf',
    'https://tau.canardoux.xyz/live/extract/04.flac', // 'assets/samples/sample.flac',
    'https://tau.canardoux.xyz/live/extract/06.mp4', // 'assets/samples/sample.mp4',
    'https://tau.canardoux.xyz/live/extract/03.amr', // 'assets/samples/sample.amr', // amrNB
    'https://tau.canardoux.xyz/live/extract/03.amr', // 'assets/samples/sample_xxx.amr', // amrWB
    'https://tau.canardoux.xyz/live/extract/09-pcm8.raw', // 'assets/samples/sample_xxx.pcm', // pcm8
    'https://tau.canardoux.xyz/live/extract/sample_f32_2ch.raw', // Raw pcmFloat32
    '', // pcmWebM
    'https://tau.canardoux.xyz/live/extract/02-opus.webm', // 'assets/samples/sample_opus.webm', // opusWebM
    'https://tau.canardoux.xyz/live/extract/03-vorbis.webm', // 'assets/samples/sample_vorbis.webm', // vorbisWebM
    'https://tau.canardoux.xyz/live/extract/sample_f32_2ch.wav', // wav Float32 stereo
  ];
