...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _initializeExample(bool withUI) async {
    ...
    if (withUI) {
      await playerModule.openAudioSessionWithUI(focus: AudioFocus.requestFocusTransient, category: SessionCategory.playAndRecord, mode: SessionMode.modeDefault, audioFlags: AudioFlags.outputToSpeaker);
    } else {
      await playerModule.openAudioSession( focus: AudioFocus.requestFocusTransient, category: SessionCategory.playAndRecord, mode: SessionMode.modeDefault, audioFlags: AudioFlags.outputToSpeaker);
    }
  ...
  Future<void> init() async {
    ...
    recorderModule.openAudioSession(focus: AudioFocus.requestFocusTransient, category: SessionCategory.playAndRecord, mode: SessionMode.modeDefault, audioFlags: AudioFlags.outputToSpeaker);
