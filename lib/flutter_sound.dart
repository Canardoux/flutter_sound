...
class FlutterSound
{
        ...
        bool get isPaused
        => soundPlayer.isPaused();

        t_AUDIO_STATE get audioState
        => isPlaying ? t_AUDIO_STATE.IS_PLAYING : isPaused ? t_AUDIO_STATE.IS_PAUSED : isRecording ? t_AUDIO_STATE.IS_RECORDING : t_AUDIO_STATE.IS_STOPPED;
