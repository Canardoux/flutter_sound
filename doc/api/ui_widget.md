...
The `MediaFormat` must also be natively supported by the OS. See [MediaFormat](https://github.com/Canardoux/tau_doc/tree/7ceca182491d5a64978949d38f11031f7b1858e1/tau/mediaformat.md) for additional details on checking for a supported format.
...
`Sounds` uses [Track](https://github.com/Canardoux/tau_doc/tree/7ceca182491d5a64978949d38f11031f7b1858e1/tau/track.md) as the primary method of handing around audio data.
