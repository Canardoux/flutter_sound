...
* [startPlayerFromStream](player.md#startplayerfromstream) to play live data. Please look to the [following notice](../guides/codec.md#playing-pcm-16-from-a-dart-stream).
* [feedFromStream](player.md#feedfromstream) to play live PCM data synchronously.  Please look to the [following notice](../guides/codec.md#playing-pcm-16-from-a-dart-stream).
...
* You use the optional parameter`codec:` for specifying the audio and file format of the file. Please refer to the [Codec compatibility Table](../guides/codec.md#actually-the-following-codecs-are-supported-by-flutter_sound) to know which codecs are currently supported.
...
* `track` parameter is a simple structure which describe the sound to play. Please see [here the Track structure specification](https://github.com/Canardoux/tau_doc/tree/7ceca182491d5a64978949d38f11031f7b1858e1/tau/track.md)
...
Please look to [the following notice](../guides/codec.md#playing-pcm-16-from-a-dart-stream)
...
* [This example](../flutter-sound/example/#liveplaybackwithbackpressure) shows how to play Live data, with Back Pressure from Flutter Sound
* [This example](../flutter-sound/example/#soundeffect) shows how to play some real time sound effects synchronously.
...
[This example](https://github.com/Canardoux/tau_doc/tree/7ceca182491d5a64978949d38f11031f7b1858e1/example/README.md#liveplaybackwithoutbackpressure) shows how to play Live data, without Back Pressure from Flutter Sound
