...
Flutter Sound is supported by Flutter Web. You can play with [this live demo on the web](https://dooboolab.github.io/flutter_sound/doc/flutter_sound/web_example) (still cannot record with Safari or any web browser on iOS). You can [read this](https://canardoux.github.io/tau/book/tau/codec.html#flutter-sound-on-flutter-web).
