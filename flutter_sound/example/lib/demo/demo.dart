...
class _MyAppState extends State<Demo> {
  ...
  List<String> remoteSample = [
    'https://tau.canardoux.xyz/taudoc/danku/extract/01.aac', // 'assets/samples/sample.aac',
    'https://tau.canardoux.xyz/taudoc/danku/extract/01.aac', // 'assets/samples/sample.aac',
    'https://tau.canardoux.xyz/taudoc/danku/extract/08.opus', // 'assets/samples/sample.opus',
    'https://tau.canardoux.xyz/taudoc/danku/extract/04-opus.caf', // 'assets/samples/sample_opus.caf',
    'https://tau.canardoux.xyz/taudoc/danku/extract/05.mp3', // 'assets/samples/sample.mp3',
    'https://tau.canardoux.xyz/taudoc/danku/extract/07.ogg', // 'assets/samples/sample.ogg',
    'https://tau.canardoux.xyz/taudoc/danku/extract/10-pcm16.raw', // 'assets/samples/sample.pcm',
    'https://tau.canardoux.xyz/taudoc/danku/extract/13.wav', // 'assets/samples/sample.wav',
    'https://tau.canardoux.xyz/taudoc/danku/extract/02.aiff', // 'assets/samples/sample.aiff',
    'https://tau.canardoux.xyz/taudoc/danku/extract/01-pcm.caf', // 'assets/samples/sample_pcm.caf',
    'https://tau.canardoux.xyz/taudoc/danku/extract/04.flac', // 'assets/samples/sample.flac',
    'https://tau.canardoux.xyz/taudoc/danku/extract/06.mp4', // 'assets/samples/sample.mp4',
    'https://tau.canardoux.xyz/taudoc/danku/extract/03.amr', // 'assets/samples/sample.amr', // amrNB
    'https://tau.canardoux.xyz/taudoc/danku/extract/03.amr', // 'assets/samples/sample_xxx.amr', // amrWB
    'https://tau.canardoux.xyz/taudoc/danku/extract/09-pcm8.raw', // 'assets/samples/sample_xxx.pcm', // pcm8
    'https://tau.canardoux.xyz/taudoc/danku/extract/12-pcmfloat.raw', // 'assets/samples/sample_xxx.pcm', // pcmFloat32
    'https://tau.canardoux.xyz/taudoc/danku/extract/02-opus.webm', // 'assets/samples/sample_opus.webm', // opusWebM
    'https://tau.canardoux.xyz/taudoc/danku/extract/03-vorbis.webm', // 'assets/samples/sample_vorbis.webm', // vorbisWebM
  ];
