...
class _MyAppState extends State<Demo> {
  ...
  List<String> assetSample = [
    'assets/extract/01.aac', // 'assets/samples/sample.aac',
    'assets/extract/01.aac', // 'assets/samples/sample.aac',
    'assets/extract/08.opus', // 'assets/samples/sample.opus',
    'assets/extract/04-opus.caf', // 'assets/samples/sample_opus.caf',
    'assets/extract/05.mp3', // 'assets/samples/sample.mp3',
    'assets/extract/07.ogg', // 'assets/samples/sample.ogg',
    'assets/extract/10-pcm16.raw', // 'assets/samples/sample.pcm',
    'assets/extract/13.wav', // 'assets/samples/sample.wav',
    'assets/extract/02.aiff', // 'assets/samples/sample.aiff',
    'assets/extract/01-pcm.caf', // 'assets/samples/sample_pcm.caf',
    'assets/extract/04.flac', // 'assets/samples/sample.flac',
    'assets/extract/06.mp4', // 'assets/samples/sample.mp4',
    'assets/extract/03.amr', // 'assets/samples/sample.amr', // amrNB
    'assets/extract/03.amr', // 'assets/samples/sample_xxx.amr', // amrWB
    'assets/extract/09-pcm8.raw', // 'assets/samples/sample_xxx.pcm', // pcm8
    'assets/extract/12-pcmfloat.raw', // 'assets/samples/sample_xxx.pcm', // pcmFloat32
    '', // 'assets/samples/sample_xxx.pcm', // pcmWebM
    'assets/extract/02-opus.webm', // 'assets/samples/sample_opus.webm', // opusWebM
    'assets/extract/03-vorbis.webm', // 'assets/samples/sample_vorbis.webm', // vorbisWebM
  ];
