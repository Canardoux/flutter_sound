...
class SoundRecorderUIState extends State<SoundRecorderUI>
{
        ...
        void initState()
        {
                ...
                ).then((toto){_registerRecorder(context, this);});
                super.initState();
        }
...
///
void connectPlayerToRecorderStream(SoundPlayerUIState playerState, Stream<PlaybackDisposition> recorderStream)
{
