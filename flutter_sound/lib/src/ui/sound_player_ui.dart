...
class SoundPlayerUIState extends State<SoundPlayerUI>
{
        ...
        {
                assert(__playState != _PlayState.playing && __playState != _PlayState.paused);
                setState(()
                {
                        if (enabled == true)
                        {
                        ...
                        (
                                ...
                                (
                                        ...
                                        builder: (context, asyncData)
                                        {
                                                ...
                                                return InkWell
                                                (
                                                        onTap: _canPlay && (_playState == _PlayState.stopped || _playState == _PlayState.playing || _playState == _PlayState.paused)  ? ()
                                                        {
