 ...
 */
export declare type RegisterPlugin = <T>(pluginName: string, implementations?: Readonly<PluginImplementations>) => T;
/**
 ...
 */
export declare type PluginImplementations = {
...
export declare type PermissionState = 'prompt' | 'prompt-with-rationale' | 'granted' | 'denied';
...
export declare type PluginCallback = (data: PluginResultData, error?: PluginResultError) => void;
