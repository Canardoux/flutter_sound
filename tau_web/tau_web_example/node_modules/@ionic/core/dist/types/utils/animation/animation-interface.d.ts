...
export declare type AnimationLifecycle = (currentStep: 0 | 1, animation: Animation) => void;
export declare type AnimationKeyFrames = [AnimationKeyFrameEdge, AnimationKeyFrameEdge] | AnimationKeyFrame[];
...
export declare type AnimationBuilder = (baseEl: any, opts?: any) => Animation;
