...
- The documentation of the API is now generated by `dartdoc`. [Here it is](https://htmlpreview.github.io/?https://github.com/Canardoux/tau/blob/master/flutter_sound/doc/api/index.html)
- The API is has been cleaned (once again). Please [look to the migration guide](https://htmlpreview.github.io/?https://github.com/Canardoux/tau/blob/master/flutter_sound/doc/migration.md)
- The various traces done by Flutter Sound with the Dart code is now handled by 'util/log.dart'. (The traces done by iOS and Android are still hard coded).;
