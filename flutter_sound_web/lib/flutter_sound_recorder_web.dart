...
class FlutterSoundRecorder {
  ...
  external void startRecorder(
      String? path, int? sampleRate, int? numChannels, int? bitRate, int codec, bool? toStream, int audioSource);
...
List<Function> callbackTable = [
  allowInterop((FlutterSoundRecorderCallback cb, int duration, double dbPeakLevel) {
  ...
  allowInterop((FlutterSoundRecorderCallback cb, int state, bool success, String url) {
