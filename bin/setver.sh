...
gsed -i  "s/^\( *s.dependency *'TauEngine', *\).*$/\1'$VERSION'/"                       flutter_sound/ios/flutter_sound_lite.podspec 2>/dev/null
gsed -i  "s/^\( *s.dependency *'TauEngine', *\).*$/\1'$VERSION'/"                       flutter_sound/ios/flauto_lite.podspec 2>/dev/null
