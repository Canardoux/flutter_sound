...
if [ "_$1" = "_TAU" ] ; then
        ...
        gsed -i  "s/^ *implementation 'xyz.larpoux:xyz.canardoux.tau_sound_core:\(.*\)$/    implementation 'xyz.larpoux:xyz.canardoux.tau_core:\1/" flutter_sound/android/build.gradle
        gsed -i  "s/^ *\/\/ implementation 'xyz.larpoux:xyz.canardoux.tau_sound_core:\(.*\)$/    \/\/implementation 'xyz.larpoux:xyz.canardoux.tau_core:\1/" flutter_sound/android/build.gradle
...
#========================================================================================================================================================================================================
        ...
        gsed -i  "s/^ *implementation 'xyz.larpoux:xyz.canardoux.tau_core:\(.*\)$/    implementation 'xyz.larpoux:xyz.canardoux.tau_sound_core:\1/" flutter_sound/android/build.gradle
        gsed -i  "s/^ *\/\/ implementation 'xyz.larpoux:xyz.canardoux.tau_core:\(.*\)$/    \/\/implementation 'xyz.larpoux:xyz.canardoux.tau_sound_core:\1/" flutter_sound/android/build.gradle
