...
public class MediaBrowserHelper {
    ...
    private FlutterSoundPlugin flutterSoundModule;
    ...
    private MediaBrowserCompat.ConnectionCallback mMediaBrowserCompatConnectionCallback = new MediaBrowserCompat.ConnectionCallback() {
        ...
        public void onConnected() {
            ...
            try {
                mediaControllerCompat = new MediaControllerCompat(flutterSoundModule.androidActivity, mMediaBrowserCompat.getSessionToken());
                MediaControllerCompat.setMediaController(flutterSoundModule.androidActivity, mediaControllerCompat);
     ...
     *
     *
     * @param module The flutterSound module in which to initialize the media browser helper.
     ...
     *                                       is unsuccessful.
     */
    MediaBrowserHelper(FlutterSoundPlugin module, boolean includeAudioPlayerFeatures, Callable<Void> serviceSuccConnectionCallback, Callable<Void> serviceUnsuccConnectionCallback) {
        //mActivity = activity;
    ...
    private void initMediaBrowser() {
        ...
        mMediaBrowserCompat = new MediaBrowserCompat(
                flutterSoundModule.ctx,
                new ComponentName(flutterSoundModule.ctx, BackgroundAudioService.class),
                //new ComponentName("com.dooboolab.fluttersound", "BackgroundAudioService"),
                mMediaBrowserCompatConnectionCallback,
                flutterSoundModule.androidActivity.getIntent().getExtras()
        );
